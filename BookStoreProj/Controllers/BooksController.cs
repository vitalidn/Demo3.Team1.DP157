...
namespace BookStoreProj.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Article,Author,Title,Genre,Price")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Article,Author,Title,Genre,Price")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
